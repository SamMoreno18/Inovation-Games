...
<head>
  ...
  <link rel="stylesheet" href="/Inovation-Games/Models/stylo.css">
</head>
    ...
    <div class="navbar">
      <div class="dropdown">
        ...
        <div class="dropdown-content" id="myDropdown">
            <a href="/Inovation-Games/Inovation/login.php">Login</a>
            <a href="/Inovation-Games/Inovation-Games/index.php">Home</a>
            <a href="/Inovation-Games/Inovation-Games/Views/Wish-list/wish-list.html">My wish list</a>
          </div>
      </div>
    </div>
    <header>
...
<body class="bg-gray-800 text-white font-sans">
  <div class="max-w-screen-lg mx-auto my-10">
    <div class="bg-gray-900 p-5 rounded-lg shadow-lg">
      ...
      <h3 id="username" class="text-lg text-center mb-3">ballinpandax</h3>
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo '<img src="../img/' . htmlspecialchars($row['url_portada']) . '" alt="Portada del juego ' . htmlspecialchars($row['nombre']) . '" style="width: 500px; height: auto;" class="img-fluid mx-auto d-block">';
              echo '<h5 class="mt-2 font-semibold">' . htmlspecialchars($row['nombre']) . '</h5>';
              echo '</div>';
          }
          echo '</div>';
      } else {
  ...
  <script src="/Inovation-Games/Models/scriptt.js "></script>
</body>
